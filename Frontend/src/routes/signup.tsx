...
import { Sparkles, Brain, Zap, BarChart3, Mail, Lock, User, Briefcase, ShieldCheck, Loader2, Sun, Moon, Star } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-8 lg:gap-16 items-start">
          <div className="space-y-10">
            ...
            <div>
              ...
              <p className="mt-5 text-lg text-muted-foreground max-w-md leading-relaxed">
                Create your workspace in seconds and start turning conversations into outcomes.
              </p>
            </div>
            ...
            <Card className="p-5 max-w-md bg-card/40 border border-border/60 rounded-2xl backdrop-blur-sm">
              <div className="flex items-center gap-4">
                ...
                <div className="text-sm leading-snug">Join 5,000+ teams already<br />collaborating smarter.</div>
              </div>
          ...
          <div className="relative">
            ...
            <Card className="relative p-8 lg:p-10 bg-card/70 border border-border/60 rounded-3xl backdrop-blur-xl elevated">
              ...
              <p className="text-muted-foreground mt-2">Get started in seconds — no credit card required.</p>

              <div className="space-y-3 mt-7">
                <Button type="button" onClick={() => social("Google")} className="w-full h-12 rounded-xl bg-foreground text-background hover:bg-foreground/90 border-0 justify-center gap-3 text-sm font-medium">
                ...
                <Button type="button" onClick={() => social("Microsoft")} className="w-full h-12 rounded-xl bg-foreground text-background hover:bg-foreground/90 border-0 justify-center gap-3 text-sm font-medium">
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <Button type="submit" disabled={loading} className="w-full h-12 rounded-xl gradient-primary text-primary-foreground border-0 glow text-base font-semibold mt-2">
                  {loading && <Loader2 className="h-4 w-4 mr-2 animate-spin" />} Create workspace
                </Button>
              </form>
