...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Log in to IntellMeet" },
      {
        name: "description",
        content: "Access your AI-powered collaboration workspace.",
      },
    ],
  }),
  component: Login,
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <p className="mt-5 text-lg text-muted-foreground max-w-md leading-relaxed">
                Log in to your account and continue transforming meetings into
                intelligence.
              </p>
            </div>
            ...
            <Card className="relative p-8 lg:p-10 bg-card/70 border border-border/60 rounded-3xl backdrop-blur-xl elevated">
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 pl-10 pr-10 rounded-xl bg-input/50"
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-12 rounded-xl gradient-primary text-primary-foreground border-0 glow text-base font-semibold"
                >
