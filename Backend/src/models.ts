...
const notificationSchema = new Schema(
  {
    ...
    type: {
      type: String,
      enum: ["meeting", "task", "mention", "ai", "workspace"],
      required: true,
    },
    title: { type: String, required: true },
    body: String,
...
const auditLogSchema = new Schema(
  {
    workspaceId: { type: objectId, ref: "Workspace", required: false, index: true },
    actorUserId: { type: objectId, ref: "User", required: false },
...
// Back-compat for analytics router that expects an AIInsights collection.
// The current schema uses AISummary; this alias keeps compilation green.
export const AIInsights = AISummary;
