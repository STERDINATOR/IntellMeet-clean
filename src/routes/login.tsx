...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Log in — IntellMeet" }] }),
  component: LoginPage,
});
    ...
    <main className="relative min-h-screen grid place-items-center px-4 overflow-hidden">
      ...
      >
        ...
        <form className="mt-8 space-y-4">
          <Field icon={Mail} type="email" placeholder="you@company.com" label="Email" />
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="rounded-xl glass py-2.5 text-sm hover:bg-white/5">Google</button>
          <button className="rounded-xl glass py-2.5 text-sm hover:bg-white/5">GitHub</button>
        </div>
